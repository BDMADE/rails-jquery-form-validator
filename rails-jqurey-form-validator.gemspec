...
require 'rails/jqurey/form/validator/version'

Gem::Specification.new do |spec|
  spec.name          = "rails-jqurey-form-validator"
  spec.version       = Rails::Jqurey::Form::Validator::VERSION
...
those functions that's needed to validate a particular form.}
  spec.homepage      = "https://github.com/bdmade/rails-jqurey-form-validator"
  spec.license       = "MIT"
